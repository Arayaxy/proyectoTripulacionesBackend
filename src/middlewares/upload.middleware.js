import { uploadImagenPonente, uploadPresentacion, uploadCV, uploadBillete, uploadDocumento } from '../config/upload.js';
...
export const billete = runUpload(uploadBillete.single('file'));
